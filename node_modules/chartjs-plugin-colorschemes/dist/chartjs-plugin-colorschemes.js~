...
Chart.defaults.plugins.colorschemes = {  //https://github.com/nagix/chartjs-plugin-colorschemes/issues/28#issuecomment-930930205
...
var ColorSchemesPlugin = {
	...
	beforeUpdate: function(chart, options) {
        ...
        var options = chart.config.options.plugins.colorschemes;    //https://github.com/nagix/chartjs-plugin-colorschemes/issues/28#issuecomment-930930205
		if (scheme) {
...
//(Chart.plugins || Chart).register(ColorSchemesPlugin);  //https://github.com/nagix/chartjs-plugin-colorschemes/issues/28#issuecomment-920693726
